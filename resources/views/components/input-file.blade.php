...
<div x-data="{ fileName: @js($fileName) }" class="flex flex-col gap-2">
    <x-input-label for="path_img" :value="__('Загрузите фото')"/>

    <div class="flex items-center gap-3">
        <label for="path_img" class="inline-flex cursor-pointer rounded-md bg-main-100 px-4 py-2 text-main-900 transition hover:bg-transparent-accent">
            Выберите файл
        </label>
